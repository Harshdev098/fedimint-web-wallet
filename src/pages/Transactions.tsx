...
import { fetchTransactions, resetTransactions, exitSearchMode, searchTransaction } from '../redux/slices/TransactionSlice';
...
export default function Transactions() {
    ...
    const { hasMore, transactions, isFetching, lastSeen } = useSelector((state: RootState) => state.transaction)
    ...
    useEffect(() => {
        if (query.trim() !== '') {
            !recoveryState.status && dispatch(searchTransaction({ query, wallet }))
        } else {
                    ...
                    {txDetail ? (
                        <div className="pegout-details-grid">
                            <div className="pegout-detail">
                                <strong>Fee:</strong> {txDetail.fee} sats
                            </div>
                            <div className="pegout-detail">
            ...
            <section className="activities-wrapper">
                <div className="activities-container">
                    ...
                    {!isFetching ? <div className="transaction-section">
                                            ...
                                            <div className="transaction-details">
                                                <div className="details-container">
                                                    ...
                                                    <div className="details-row">
                                                        ...
                                                        {tx.fee && <div className="detail-group">
                                                            <span className="detail-label">Network Fees</span>
                                                            <span className="detail-value">{tx.fee / 1000}</span>
                                                        </div>}
                                                    </div>
                                                    <div className="details-row">
                        ...
                        {(hasMore === true) && <div className="pagination-container">
                            <button className="pagination-button" disabled={isFetching} onClick={() => handleLoadMore()}>
                                {isFetching ? 'Loading...' : hasMore ? 'Load More' : 'show less'}
                            </button>
                        </div>}
