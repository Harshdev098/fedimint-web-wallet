        ...
        try {
            ...
            if (result) {
                ...
                setErrorWithTimeout({
                    ...
                    message: "Withdrawal didn't give result",
                });
            }
        } catch (err) {
                ...
                <div className="modalOverlay">
                    <div className="createInvoice">
                        <button
                            type="button"
                            className="closeBtn"
                            onClick={() => setOpenDepositBox(false)}
                        >
                            <i className="fa-solid fa-xmark"></i>
                        </button>
                        <p className="title-span" style={{ textAlign: 'left', fontSize: '16px' }}>
                            <i className="fa-solid fa-info-circle"></i> Use the generated address to
                            deposit funds from external address to federation. It can take time to
                            credit your balance
                        </p>
                ...
                <div className="modalOverlay">
                    <div className="createInvoice">
                        <button
                            type="button"
                            className="closeBtn"
                            onClick={() => setOpenWithdrawBox(false)}
                        >
                            <i className="fa-solid fa-xmark"></i>
                        </button>
                        <h2 style={{ marginBottom: '4px' }}>
                            <i className="fa-brands fa-bitcoin"></i> Withdraw Funds
                        </h2>
                        <p className="title-span">
                            Amount will be transfered to onchain address via bitcoin network
                        </p>
                        ...
                        {WithdrawOperationId && (
                            <div className="pegout-details">
                                ...
                                >
                                    <i className="fa-solid fa-info-circle"></i> You can view and
                                    manage these trasactions at any time in{' '}
                                ...
                                <Tippy content="This can led to privacy concerns">
                                    <button
                                        className="mempool-btn"
                                        onClick={() => {
                                            if (
                                                confirm(
                                                    'This can lead to privacy concerns with your IP address'
                                                )
                                            ) {
                                                window.open(
                ...
                <div className="activities-container">
                    ...
                    <div className="activities-header">
                        <div className="tx-">
                            ...
                            <p className="subtitle">
                                Deposit & Withdraw funds to an external onchain address from and to
                                federation
                            </p>
                        </div>
                    </div>
                    <section className="onchain-container">
                        <div className="onchain-detail-grid">
                            <div className="modules-grid">
                                {Object.entries(Details?.modules ?? {})
                                    .filter(([, mod]) => (mod as WalletModule).kind === 'wallet')
                                    .map(([, mod]) => {
                        ...
                        <div className="onchain-actions">
                            ...
                            <button
                                disabled={recoveryState.status}
                                onClick={() => setOpenWithdrawBox(true)}
                            >
