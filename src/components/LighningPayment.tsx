...
import {
    ...
    setPayInvoiceResult,
} from '../redux/slices/LightningPayment';
...
import {
    ...
    subscribeLnPay,
    subscribeLnReceive,
    subscribeInternalPay,
} from '../services/LightningPaymentService';
...
export default function LighningPayment() {
    ...
    const { Invoice, payInvoiceResult, payStatus, invoiceExpiry } = useSelector(
    ...
    const handleCreateInvoice = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const unsubscribe = subscribeLnReceive(wallet, result.operationId, dispatch);
            setTimeout(
                () => {
                    unsubscribe?.();
                },
            ...
            if (localStorage.getItem('locationAccess') === 'true') {
                navigator.geolocation.getCurrentPosition(
                    (position) => {
                        ...
                        let locations: {
                            [invoiceId: string]: { latitude: number; longitude: number };
                        } = {};
    ...
    return (
        <>
            ...
            <QRScanner
                ...
                onResult={(data) => handlePayWithQR(data)}
            />
            {openRecieveBox && (
                <div className="modalOverlay">
                    <div className="createInvoice">
                        ...
                        <h2 style={{ marginBottom: '4px' }}>
                            <i className="fa-solid fa-bolt"></i> Create Lightning Invoice
                        </h2>
                        <p className="title-span">
                            Receive eCash directly from the Lightning network
                        </p>
                        <form onSubmit={handleCreateInvoice}>
                            ...
                            <input
                                ...
                                required
                            />
                            <button type="submit" disabled={generatingInvoice}>
                                Create
                            </button>
                        </form>
                        {Invoice && (
                            <div className="createInvoiceResult">
                                <div className="qrCode">
                                    ...
                                    <button type="button" onClick={() => downloadQRCode('invoice')}>
                                        Download QR
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className="payInvoice">
                        <button
                            ...
                            onClick={() => {
                                ...
                                dispatch(setPayInvoiceResult(null));
                            }}
                        >
                            <i className="fa-solid fa-xmark"></i>
                        </button>
                        <h2 style={{ marginBottom: '4px' }}>
                            <i className="fa-solid fa-bolt"></i> Pay Lightning Invoice
                        </h2>
                        ...
                        <form onSubmit={handlePayInvoice}>
                            ...
                            <button type="submit" disabled={payingInvoice}>
                                Pay Invoice
                            </button>
                        </form>
                        {payInvoiceResult && (
                            <div className="invoiceDetailGroupModern">
                                ...
                                <div className="invoiceDetailCard">
                                    <b>Pay Type:</b> {payInvoiceResult.payType}
                                </div>
                                <div className="invoiceDetailCard">
                                    <b>Fees Paid:</b> {payInvoiceResult.fee / 1000} sat
                                </div>
