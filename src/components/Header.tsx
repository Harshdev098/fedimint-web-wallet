...
export default function Header() {
    ...
    const [ActiveFederation, setActiveFederation] = useState<{
        name: string | undefined;
        fedId: string | undefined;
    }>({ name: undefined, fedId: undefined });
                        ...
                        >
                            <div className="selected-option">
                                ...
                                <span className="dropdown-text">
                                    {ActiveFederation.name || 'Select Federation'}
                                </span>
                            </div>
                            <i
                        ...
                        {isOpen && (
                            <div className="dropdown-menu">
                                ...
                                <ul className="dropdown-option">
                                    {isLoadingAvailableFederations && (
                                        <li>Fetching federations...</li>
                                    )}

                                    {!isLoadingAvailableFederations &&
                                        availableWalletList?.length === 0 && (
                                            <li>No other federations found</li>
                                        )}

                                    {!isLoadingAvailableFederations &&
                                        availableWalletList?.length > 0 &&
                                        availableWalletList.map((w, key) => (
